...
public class OpenApi {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=VNaqzDwNJ%2FOM63fE4jF24L%2Bjmj59Bi%2FUtih0EOI0rGttlzFNccoDOGBf2oJl7y7vdy%2B1AWZPVvEYcVEFgn%2FTUA%3D%3D"); /*Service Key*/
        ...
        urlBuilder.append("&" + URLEncoder.encode("keyword","UTF-8") + "=" + URLEncoder.encode("해운대", "UTF-8")); /*지역코드, 시군구코드*/
